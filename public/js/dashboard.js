...
function removeUserFromProduct(ProductId) {
  sweetalert2__WEBPACK_IMPORTED_MODULE_1__.fire({
    ...
    if (result.isConfirmed) {
      _products_js__WEBPACK_IMPORTED_MODULE_0__.Products.removeUserFromProduct(ProductId, loadUsersToDiv).then(function (result) {
        console.log(result);
      });
    }
  });
...
function loadUsersToDiv() {
  var typeDiv = $('#products').length > 0 ? $('#products') : $('#events');
  _products_js__WEBPACK_IMPORTED_MODULE_0__.Products.getUserProducts(typeDiv.attr('id')).then(function (response) {
    var ProductDiv = "";
    response.data.forEach(function (Product) {
      ProductDiv += "\n                <div class=\"card my-4\">\n                    <div class=\"row g-0\">\n                        <div class=\"col-md-4\">\n                            <div class=\"card-header\">\n                                Tags\n                            </div>\n                            <div class=\"card-body\">\n                                <h5 class=\"card-title\">".concat(Product.name, "</h5>\n                                <p class=\"card-text\">").concat(Product.details, "</p>\n                                <button class=\"btn btn-primary\" href=\"/Product/").concat(Product.id, "\" id=\"").concat(Product.id, "\" data-Product-id=\"").concat(Product.id, "\">Remove from Product</button>\n                            </div>\n                        </div>\n                        <div class=\"col-md-8\">\n                            <div style=\"width: 100%;height: 220px;background-image: url(").concat(Product.img, ");background-size: cover;background-repeat: no-repeat;\"\n                            class=\"img-fluid rounded-start\" alt=\"").concat(Product.name, "\">\n                            </div>\n                        </div>\n                    </div>\n                </div>\n            ");
      typeDiv.on('click', "#".concat(Product.id), function () {
